...
--! @brief Top-level 3D graphics engine system integrating UART, RAM, 3D rotator, projector, bitmap, VRAM, and VGA
--! @details
--! Implements the full 3D visualization pipeline:
--! 1. UART receives bytes representing 3D point coordinates.
--! 2. Memory loader and reader manage RAM.
...
architecture structural of main_bram is
    -- UART
    ...
    signal reader_ram_addr  : std_logic_vector(RAM_ADDR_WIDTH - 1 downto 0);        
    ...
    signal loader_ram_addr  : std_logic_vector(RAM_ADDR_WIDTH - 1 downto 0);    
